...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        String[] message = {messageSource.getMessage("meal.dateTimeDuplicateError", null, LocaleContextHolder.getLocale())};
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String[] customMessage) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, customMessage == null ? new String[]{(rootCause.getMessage())} : customMessage);
    }
}